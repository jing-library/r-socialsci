...
To make it easier to interact with R, we will use [RStudio](https://rstudio.com), the most popular IDE (Integrated Development Environmemt) for R, to write R scripts and to interact with the R software. To function correctly, RStudio needs R and therefore both need to be installed on your computer.
